...
bool Parser::parseExpression(Expr *&E) {
  auto _errorhandler = [this] {
    return skipUntil(tok::r_paren, tok::comma, tok::semi, tok::kw_DO,
                     tok::kw_ELSE, tok::kw_END, tok::kw_THEN, tok::r_square);
  };
...
bool Parser::parseTerm(Expr *&E) {
  auto _errorhandler = [this] {
    return skipUntil(tok::hash, tok::r_paren, tok::plus, tok::comma, tok::minus,
                     ...
                     tok::kw_END, tok::kw_OR, tok::kw_THEN, tok::r_square);
  };
  if (parseFactor(E))
    return _errorhandler();
...
bool Parser::parseFactor(Expr *&E) {
  auto _errorhandler = [this] {
    return skipUntil(tok::hash, tok::r_paren, tok::star, tok::plus, tok::comma,
                     tok::minus, tok::slash, tok::semi, tok::less,
                     tok::lessequal, tok::equal, tok::greater,
                     tok::greaterequal, tok::kw_AND, tok::kw_DIV, tok::kw_DO,
                     tok::kw_ELSE, tok::kw_END, tok::kw_MOD, tok::kw_OR,
                     tok::kw_THEN, tok::r_square);
  };
...
bool Parser::parseSelectors(Expr *&E) {
  auto _errorhandler = [this] {
    return skipUntil(tok::hash, tok::r_paren, tok::star, tok::plus, tok::comma,
                     tok::minus, tok::slash, tok::colonequal, tok::semi,
...
bool Parser::parseQualident(Decl *&D) {
  auto _errorhandler = [this] {
    return skipUntil(tok::hash, tok::l_paren, tok::r_paren, tok::star,
                     tok::plus, tok::comma, tok::minus, tok::period, tok::slash,
                     ...
                     tok::kw_MOD, tok::kw_OR, tok::kw_THEN, tok::l_square,
